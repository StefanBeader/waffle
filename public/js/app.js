...
document.addEventListener("DOMContentLoaded", function () {
  var classname = document.querySelectorAll(".link");
  var activeSection = classname[0];

  for (var i = 0; i < classname.length; i++) {
    classname[i].addEventListener('click', function (e) {
      e.preventDefault(); // changeActiveSection(e.target, activeSection);
  ...
  var classnameMenu = document.querySelectorAll(".menu-btn");
  var activeMenuType = classnameMenu[0];

  for (var _i = 0; _i < classnameMenu.length; _i++) {
    classnameMenu[_i].addEventListener('click', function (e) {
...
function changeMenuFlavour(id) {
  var itemsToHide = document.querySelectorAll(".category");
  var _iteratorNormalCompletion2 = true;
  var _didIteratorError2 = false;
  var _iteratorError2 = undefined;

  try {
    for (var _iterator2 = itemsToHide[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
  ...
  var itemsToShow = document.querySelectorAll("[data-flavourId=\"".concat(id, "\"]"));
  var _iteratorNormalCompletion3 = true;
  var _didIteratorError3 = false;
  var _iteratorError3 = undefined;

  try {
    for (var _iterator3 = itemsToShow[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
...
var GoogleMapsLoader = __webpack_require__(/*! google-maps */ "./node_modules/google-maps/lib/Google.js");
